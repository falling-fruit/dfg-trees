...
const wfs_url_with_less_than_1500_results = "https://data.gov.au/geoserver/tree-register/wfs?service=WFS&version=2.0.0&request=GetFeature&typeNames=ckan_13079796_1b3a_448d_8a09_d7fda5611c5f&srsName=EPSG:4326&";
...
async function pageThroughResults(getFeatureUrl) {
    var max_results_per_page = 200; // FEEL FREE TO CHANGE THIS IF USING A WFS URL LINK THAT HAS MORE THAN 1500 ITEMS. VIEW THE AVAILABLE WFS URLS AT THE TOP OF THIS FILE.
    var startIndex = 0;
    var statusCode = 200;
    var iterations = 0;
    var xmlFiles = [];
 ...
 */
downloadWfsDataInXmlFormat("https://data.gov.au/geoserver/tree-register/wfs?service=WFS&version=2.0.0&request=GetFeature&typeNames=ckan_13079796_1b3a_448d_8a09_d7fda5611c5f&srsName=EPSG:4326")